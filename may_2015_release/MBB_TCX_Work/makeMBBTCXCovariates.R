# Goal: build MBB TCX covariates table. Per Dr. Younkin, "We ran RNASeq on 278 mayo temporal cortex samples plus 10 samples from rush/broad = 288 samples." NOTE: of the 288 RNAseq samples, 10 are “sample-swap” samples from RUSH/Broad and 278 are Mayo temporal cortex samples
