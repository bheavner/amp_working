...
# copy sample swap output (not the .bam or .bai files for now) to s3://mayo-u01-rnaseq/rush_broad_ss/snapr/
...
## after processing, check that all samples are in s3://mayo-u01-rnaseq/rush_broad_ss/snapr/
